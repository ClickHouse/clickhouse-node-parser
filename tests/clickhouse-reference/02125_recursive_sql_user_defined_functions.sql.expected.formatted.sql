-- Tags: no-parallel
SYSTEM DROP  FUNCTION IF EXISTS 02125_function;

CREATE FUNCTION `02125_function` AS x -> `02125_function`(x);

SELECT `02125_function`(1); --{serverError UNSUPPORTED_METHOD};

SYSTEM DROP  FUNCTION 02125_function;

SYSTEM DROP  FUNCTION IF EXISTS 02125_function_1;

CREATE FUNCTION `02125_function_1` AS x -> `02125_function_2`(x);

SYSTEM DROP  FUNCTION IF EXISTS 02125_function_2;
...
SYSTEM DROP  FUNCTION 02125_function_1;

SYSTEM DROP  FUNCTION 02125_function_2;