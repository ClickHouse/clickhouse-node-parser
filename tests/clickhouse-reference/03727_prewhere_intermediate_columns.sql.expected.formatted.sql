...
INSERT INTO FUNCTION file(concat(currentDatabase(), '/03727_prewhere_intermediate_columns.parquet')) SETTINGS engine_file_truncate_on_insert = 1, max_threads = 1, output_format_parquet_row_group_size = 5 SELECT number * 10 AS x
FROM numbers(20)
SETTINGS
    max_threads = 1,
