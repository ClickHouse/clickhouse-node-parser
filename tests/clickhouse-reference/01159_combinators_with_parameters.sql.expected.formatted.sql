...
SELECT quantileArrayState(0.10)([number])
FROM numbers(100);

CREATE TEMPORARY TABLE t1 AS
SELECT quantileDistinctState(0.10)(number)
FROM numbers(100);

CREATE TEMPORARY TABLE t2 AS
SELECT quantileForEachState(0.10)([number])
FROM numbers(100);

CREATE TEMPORARY TABLE t3 AS
SELECT quantileIfState(0.10)(number, number % 2)
FROM numbers(100);

CREATE TEMPORARY TABLE t4 AS
SELECT quantileMergeState(0.10)(state)
FROM (
        SELECT quantileState(0.10)(number) AS state
        FROM numbers(100)
    );

CREATE TEMPORARY TABLE t5 AS
SELECT quantileOrNullState(0.10)(number)
FROM numbers(100);

CREATE TEMPORARY TABLE t6 AS
SELECT quantileOrDefaultState(0.10)(number)
FROM numbers(100);
...
SELECT quantileState(0.10)(number)
FROM numbers(100);

CREATE TEMPORARY TABLE t9 AS
SELECT quantileArrayResampleOrDefaultIfState(0.10, 1, 2, 42)([number], number, number % 2)
FROM numbers(100);

INSERT INTO t0 SELECT quantileArrayState(0.10)([number])
FROM numbers(100);

INSERT INTO t1 SELECT quantileDistinctState(0.10)(number)
FROM numbers(100);

INSERT INTO t2 SELECT quantileForEachState(0.10)([number])
FROM numbers(100);

INSERT INTO t3 SELECT quantileIfState(0.10)(number, number % 2)
FROM numbers(100);

INSERT INTO t4 SELECT quantileMergeState(0.10)(state)
FROM (
        SELECT quantileState(0.10)(number) AS state
        FROM numbers(100)
    );

INSERT INTO t5 SELECT quantileOrNullState(0.10)(number)
FROM numbers(100);

INSERT INTO t6 SELECT quantileOrDefaultState(0.10)(number)
FROM numbers(100);

INSERT INTO t7 SELECT quantileResampleState(0.10, 1, 2, 42)(number, number)
FROM numbers(100);

INSERT INTO t8 SELECT quantileState(0.10)(number)
FROM numbers(100);

INSERT INTO t9 SELECT quantileArrayResampleOrDefaultIfState(0.10, 1, 2, 42)([number], number, number % 2)
FROM numbers(100);
