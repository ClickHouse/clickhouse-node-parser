...
INSERT INTO nullable_tuple_sparse_2 SELECT if(number % 5 == 0, (number, toString(number)), NULL)
FROM numbers(1000);
...
INSERT INTO test_structure SELECT if(number % 3 == 0, (number, number * 123456789), NULL)
FROM numbers(10);
...
INSERT INTO test_structure_2 SELECT if(number % 3 == 0, (number, number * 123456789), (0, 0))
FROM numbers(10);
