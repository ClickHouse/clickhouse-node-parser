...
INSERT INTO summing_mt_aggregating_column SELECT
    1,
    2,
    [333, 444],
    groupArrayArrayState([toUInt64(33), toUInt64(44)]);
...
SELECT
    Key,
    any(Value),
    any(ConcatArraySimple),
    groupArrayArrayMerge(ConcatArrayComplex)
FROM summing_mt_aggregating_column
GROUP BY Key;