...
DESCRIBE TABLE file(concat(currentDatabase(), '_data_02304.parquet'));
...
DESCRIBE TABLE file(concat(currentDatabase(), '_data_02304.orc'));
...
DESCRIBE TABLE file(concat(currentDatabase(), '_data_02304.arrow'));