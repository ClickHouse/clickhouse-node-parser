...
SYSTEM DROP  TABLE IF EXISTS {CLICKHOUSE_DATABASE:Identifier}.mt_buffer_00158;

SYSTEM DROP  TABLE IF EXISTS {CLICKHOUSE_DATABASE:Identifier}.mt_00158;
...
INSERT INTO {CLICKHOUSE_DATABASE:Identifier}.mt_buffer_00158 (x) SELECT number AS x
FROM `system`.numbers
LIMIT 100000;
