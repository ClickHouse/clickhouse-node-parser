...
SYSTEM DROP  TABLE IF EXISTS replicated_table_for_alter1;

SYSTEM DROP  TABLE IF EXISTS replicated_table_for_alter2;
...
SYSTEM DROP  TABLE IF EXISTS replicated_table_for_reset_setting1;

SYSTEM DROP  TABLE IF EXISTS replicated_table_for_reset_setting2;
