...
SELECT sparseGrams(concat('hello ', number, ' world'))
FROM numbers(3);
...
SELECT sparseGramsUTF8(concat('a😊Ω𐍈', number, '🦄𝄞bЦ⛄', 4))
FROM numbers(3);
...
SELECT sparseGramsHashes(concat('hello ', number, ' world'))
FROM numbers(3);
...
SELECT sparseGramsHashesUTF8(concat('a😊Ω𐍈', number, '🦄𝄞bЦ⛄', 4))
FROM numbers(3);
