SYSTEM DROP  DICTIONARY IF EXISTS 02843_dict;

SYSTEM DROP  TABLE IF EXISTS 02843_source;

SYSTEM DROP  TABLE IF EXISTS 02843_join;
...
SYSTEM DROP  DICTIONARY 02843_dict;

SYSTEM DROP  TABLE 02843_source;

SYSTEM DROP  TABLE 02843_join;