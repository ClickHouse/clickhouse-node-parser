...
INSERT INTO FUNCTION file(concat(currentDatabase(), '03164_adapting_parquet_reader_output_size.parquet'), Parquet, 'short String, long1 String, long2 String, long_low_cardinality String') SELECT
    number % 100,
