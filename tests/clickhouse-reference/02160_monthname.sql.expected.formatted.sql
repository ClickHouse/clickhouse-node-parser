WITH toDate('2021-01-14') AS date_value,
...
SELECT
    ...
    monthName(date_time_value),
    monthName(date_time_64_value);

WITH toDate('2021-02-14') AS date_value,
...
WITH toDate('2021-03-14') AS date_value,
...
WITH toDate('2021-05-14') AS date_value,
...
WITH toDate('2021-06-14') AS date_value,
...
WITH toDate('2021-07-14') AS date_value,
...
WITH toDate('2021-08-14') AS date_value,
...
WITH toDate('2021-09-14') AS date_value,
...
WITH toDate('2021-10-14') AS date_value,
...
WITH toDate('2021-11-14') AS date_value,
...
WITH toDate('2021-12-14') AS date_value,
