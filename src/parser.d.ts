...
export type StartRuleNames = "Statements";
export interface ParseOptions<T extends StartRuleNames = "Statements"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Statements">>(
  input: string,
  options?: Options,
): any;
