...
SELECT range(0::Nullable(UInt64), NULL::Nullable(UInt64), 2::Nullable(UInt64));

SELECT range(0::Nullable(UInt64), 10::Nullable(UInt64), NULL::Nullable(UInt64));

SELECT range(NULL::Nullable(UInt8), materialize(1));