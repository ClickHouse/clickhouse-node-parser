SYSTEM DROP  TABLE IF EXISTS qbits_16;
...
SYSTEM DROP  TABLE qbits_16;

SYSTEM DROP  TABLE IF EXISTS qbits_32;
...
SYSTEM DROP  TABLE qbits_32;

SYSTEM DROP  TABLE IF EXISTS qbits_64;
...
SYSTEM DROP  TABLE IF EXISTS array_64;

SYSTEM DROP  TABLE IF EXISTS array_32;

SYSTEM DROP  TABLE IF EXISTS array_16;

SYSTEM DROP  TABLE IF EXISTS qbit_64;

SYSTEM DROP  TABLE IF EXISTS qbit_32;

SYSTEM DROP  TABLE IF EXISTS qbit_16;
...
SYSTEM DROP  TABLE array_64;

SYSTEM DROP  TABLE array_32;

SYSTEM DROP  TABLE array_16;

SYSTEM DROP  TABLE qbit_64;

SYSTEM DROP  TABLE qbit_32;

SYSTEM DROP  TABLE qbit_16;