-- month with 30 days
WITH toDate('2021-09-12') AS date_value,
...
SELECT
    toLastDayOfMonth(date_value),
    toLastDayOfMonth(date_time_value),
    toLastDayOfMonth(date_time_64_value);

-- month with 31 days
WITH toDate('2021-03-12') AS date_value,
...
WITH toDate('2021-02-12') AS date_value,
...
-- leap year February
WITH toDate('2020-02-12') AS date_value,
...
WITH toDate('2021-12-12') AS date_value,
...
WITH toDate('2020-12-12') AS date_value,
...
-- boundaries
WITH toDate('1970-01-01') AS date_value,
