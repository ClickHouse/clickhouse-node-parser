...
SELECT L2Distance([1, 2], (3,4));

SELECT L2SquaredDistance([1, 2], (3,4));

SELECT LpDistance([1, 2], [3,4]);

SELECT LpDistance([1, 2], [3,4], -1.);

SELECT LpDistance([1, 2], [3,4], 'aaa');

SELECT LpDistance([1, 2], [3,4], materialize(2.7));
