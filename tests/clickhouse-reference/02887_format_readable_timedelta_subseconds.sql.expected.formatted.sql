...
SELECT formatReadableTimeDelta(elapsed, maximum_unit, minimum_unit);

WITH 'milliseconds' AS maximum_unit,

arrayJoin([0, 1.0005]) AS elapsed

SELECT formatReadableTimeDelta(elapsed, maximum_unit);